...
| `lifecycle` _[Lifecycle](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#lifecycle-v1-core)_ | _(Optional)_ Actions the management system should take in response to container<br />lifecycle events. If omitted, a default preStop hook that sleeps for 30 seconds<br />is used.<br />[More info](https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/) |  |  |
