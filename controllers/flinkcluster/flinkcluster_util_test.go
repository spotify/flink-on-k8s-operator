...
func TestGetUpdateState(t *testing.T) {
	var observed = ObservedClusterState{
		...
		podDisruptionBudget: model.ClusterPodDisruptionBudget{
			PodDisruptionBudgetV1:      &policyv1.PodDisruptionBudget{ObjectMeta: metav1.ObjectMeta{Labels: map[string]string{RevisionNameLabel: "cluster-85dc8f749"}}},
			PodDisruptionBudgetV1beta1: nil,
		},
	...
	observed = ObservedClusterState{
		...
		podDisruptionBudget: model.ClusterPodDisruptionBudget{
			PodDisruptionBudgetV1:      &policyv1.PodDisruptionBudget{ObjectMeta: metav1.ObjectMeta{Labels: map[string]string{RevisionNameLabel: "cluster-aa5e3a87z"}}},
			PodDisruptionBudgetV1beta1: nil,
		},
		jmStatefulSet: &appsv1.StatefulSet{ObjectMeta: metav1.ObjectMeta{Labels: map[string]string{RevisionNameLabel: "cluster-aa5e3a87z"}}},
