...
type ObservedClusterState struct {
	...
	podDisruptionBudget    runtime.Object
...
func (observer *ClusterStateObserver) observe(
	...
	// policy/v1beta1/PodDisruptionBuget is  unavailable < v1.25
	podDisruptionBugetV1beta1UnavailableVersion, _ := semver.NewVersion(v1beta1.PodDisruptionBudgetV1beta1UnavailableVersion)

	if observed.k8sServerVersion.LessThan(podDisruptionBugetV1beta1UnavailableVersion) {
		...
		if err != nil {
			...
			log.Info("Observed PodDisruptionBudget", "state", *observedPodDisruptionBudgetV1beta1)
			observed.podDisruptionBudget = observedPodDisruptionBudgetV1beta1
		}
	} else {
		observed.podDisruptionBudget = nil
	}
	if observed.podDisruptionBudget == nil && observed.k8sServerVersion.GreaterThanOrEqual(podDisruptionBugetV1AvailableVersion) {
